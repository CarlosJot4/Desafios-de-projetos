...
def main():
    ...
    while True:
        ...
        elif opcao == "2": # Opção  de criar nova conta
        ...
        elif opcao == "6": # Opção para ver o extrato
...
def cadastrar_clientes(lista_clientes):
    ...
    lista_clientes.append({"cpf":cpf, "nome":nome, "data_nascimento": data_nascimento, "endereço":endereco})
